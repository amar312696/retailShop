    ...
    return(
        <div className="allaboutproduct">
            <div className="productimage">
                <img className="imgproduct" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8citQ5WWfEFBFNXcJ3O0evtaOsAjI-t9eW_gxdCIOIR0_EfAOuARng1qit9hTA40w8nM&usqp=CAU" alt="bhujia" />
            </div>
