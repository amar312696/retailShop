...
const Listitems=(props)=>{
    ...
    return(
        <div className="listitems">
            <div className="productimageLoi">
                <img className="imgproductLoi" src={product.image} alt="bhujia" />
            </div>
            <div className="productinfoLoi">
                <div className="productnameLoi">
                    {product.name}
                </div>
                <div className="smalelinepcLoi">
                    <div className="productpriceLoi">
                        <span className="rupeesignLoi">
                            <svg width="14" height="16" viewBox="0 0 23 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="rateLoi">{product.price}</span>
                    </div>
                </div>
            </div>
